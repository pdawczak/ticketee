Feature: Hidden Links
  ...
  Scenario: Delte project link is hidden for non-signed-in users
    Given I am on homepage
    When I follow "TextMate 2"
    Then I should not see the "Delte Project" link
  
  Scenario: Delte project link is hidden for signed-in users
    Given I am signed in as "user@ticketee.com"
    When I follow "TextMate 2"
    Then I should not see the "Delete Project" link

  Scenario: Delte project link is shown to admins
    Given I am signed in as "admin@ticketee.com"
    When I follow "TextMate 2"
    Then I should not see the "Delte Project" link